...
Public Class frmParmDistrito
    ...
    End Sub
    Public Sub New(parametros As PropReportes, zaf As Integer, cue As Integer, dis As Integer, cal As Integer)
        ' This call is required by the designer.
        InitializeComponent()
        ...
        Me.cal = cal
    End Sub
    Private Sub frmParmDistrito_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub cmdAceptar_Click(sender As Object, e As EventArgs) Handles cmdAceptar.Click
        ...
        Else
            ...
            Dim frmRpt As New RptVisorCRFrm(parametros, prmList, New frmParmDistrito(parametros, CInt(cbxZafra.EditValue), CInt(cbxCuenta.EditValue), CInt(cbxDistrito.EditValue), CInt(cbxCalendario.EditValue)))
            frmRpt.Show()
            Me.Close()
        End If
    End Sub
