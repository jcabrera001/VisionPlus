...
Public Class frmParmFiltroSubCuenta
    ...
    End Sub
    Public Sub New(parametros As PropReportes, zaf As Integer, cal As Integer, subcu As Integer)
        ' This call is required by the designer.
        InitializeComponent()
    ...
    End Sub
    Private Sub frmParmFiltroSubCuenta_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub cmdAceptar_Click(sender As Object, e As EventArgs) Handles cmdAceptar.Click
        ...
        Else
            ...
            Dim frmRpt As New RptVisorCRFrm(parametros, prmList, New frmParmFiltroSubCuenta(parametros, CInt(cbxZafra.EditValue), CInt(cbxCalendario.EditValue), CInt(cbxSubCuenta.EditValue)))
            frmRpt.Show()
            Me.Close()
        End If
    End Sub
